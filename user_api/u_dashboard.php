...
$h = new Estate();
	...
	$papi = array(array("title"=>"Properties","report_data"=>$total_property,"url"=>'images/dashboard/property.png'),array("title"=>"Extra Images","report_data"=>$total_extra_image,"url"=>'images/dashboard/extra_images.png'),array("title"=>"Gallery Category","report_data"=>$total_gallery_category,"url"=>'images/dashboard/category.png'),array("title"=>"Gallery Images","report_data"=>$total_gallery_image,"url"=>'images/dashboard/gallery_image.png'),array("title"=>"Bookings","report_data"=>intval($total_Booking),"url"=>'images/dashboard/my-booking.png'),array("title"=>"Earnings","report_data"=>$finalearn,"url"=>'images/dashboard/my-earning.png'),array("title"=>"Enquiries","report_data"=>intval($total_enquiry),"url"=>'images/dashboard/my-inquiry.png'),array("title"=>"Reviews","report_data"=>$total_review,"url"=>'images/dashboard/review.png'),array("title"=>"Payouts","report_data"=>floatval($payout),"url"=>'images/dashboard/my-payout.png'));
