...
?>
												...
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $ulist_per)) {
				?>
                                                ...
                                                <td><span data-id="<?php echo $row['id'];?>" data-status="0"
                                                        data-type="update_status" coll-type="userstatus"
                                                        class="drop badge badge-danger">Deactivate</span></td>
                                                <?php } else { ?>

                                                <td>
                                                    <span data-id="<?php echo $row['id'];?>" data-status="1"
                                                        data-type="update_status" coll-type="userstatus"
                                                        class="badge drop  badge-success">Activate</span>
                                                </td>
                                                <?php } ?>
                                                <?php 
									   }			
		...
		else 
		{
			?>
                                                ...
                                                <td><span class=" badge badge-success">Subscribed</span></td>
                                                <?php } else { ?>
...
if(empty($pname['title']))
	...
	else 
	{
		?>
                                                <td><span
                                                        class=" badge badge-success"><?php echo $pname['title']; ?></span>
                                                </td>
                                                <?php 
...
if(empty($row['start_date']))
	...
	else 
	{
		?>
                                                <td><span
                                                        class=" badge badge-success"><?php echo $row['start_date']; ?></span>
                                                </td>
                                                <?php 
...
if(empty($row['end_date']))
	...
	else 
	{
		?>
                                                <td><span
                                                        class=" badge badge-success"><?php echo $row['end_date']; ?></span>
                                                </td>
                                                <?php 
