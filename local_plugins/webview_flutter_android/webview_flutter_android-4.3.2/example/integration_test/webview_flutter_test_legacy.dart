...
Future<void> main() async {
  ...
  group('Programmatic Scroll', () {
    testWidgets('setAndGetScrollPosition', (WidgetTester tester) async {
      ...
      // time to settle.
      expect(scrollPosX, isNot(xScroll));
      expect(scrollPosX, isNot(yScroll));
  ...
  group('SurfaceAndroidWebView', () {
    ...
    testWidgets('setAndGetScrollPosition', (WidgetTester tester) async {
      ...
      int scrollPosX = await controller.getScrollX();
      int scrollPosY = await controller.getScrollY();
      expect(xScroll, scrollPosX);
      expect(yScroll, scrollPosY);

      // Check scrollBy() (on top of scrollTo())
      await controller.scrollBy(xScroll, yScroll);
      scrollPosX = await controller.getScrollX();
      scrollPosY = await controller.getScrollY();
      expect(xScroll * 2, scrollPosX);
      expect(yScroll * 2, scrollPosY);
    });
