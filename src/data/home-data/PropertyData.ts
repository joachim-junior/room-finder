...
const property_data: DataType[] = [
...

  {
    ...
    property_info: [
      ...
      { icon: propertyIcon_1, feature: "guest", total_feature: 4 },
    ],
    price: 15000.0,
    carousel: "1",
  },
  {
    ...
    property_info: [
      ...
      { icon: propertyIcon_1, feature: "guest", total_feature: 6 },
    ],
    data_delay_time: "0.1s",
    price: 18000.0,
    carousel: "2",
