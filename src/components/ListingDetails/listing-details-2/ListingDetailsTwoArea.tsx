...
interface ListingDetailsTwoAreaProps {
  propertyData?: any;
}

const ListingDetailsTwoArea = ({
  propertyData,
}: ListingDetailsTwoAreaProps) => {
      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-xl-8">
            ...
            <CommonSimilarProperty currentPropertyId={propetydetails.id || 0} />
            ...
            <div className="review-form bg-white shadow4 border-20 p-40 mb-50">
              <CommonReviewForm propertyId={propetydetails.id || 0} />
            </div>
          </div>
          <Sidebar />
        </div>
