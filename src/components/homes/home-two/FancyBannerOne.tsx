                ...
                <div className="row">
                  ...
                  <div className="col-lg-8">
                    <p className="fs-24 color-dark">
                      Cameroon&apos;s #1 guesthouse marketplace. Secure booking,
                      verified listings, and local support. Book with confidence
                      and enjoy your stay in Cameroon&apos;s top cities.
                    </p>
                    <div
